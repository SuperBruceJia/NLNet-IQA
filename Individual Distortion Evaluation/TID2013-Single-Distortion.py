...
def run(args):
    ...
    # TID2013
    TID2013info = mat73.loadmat('benchmark/TID2013fullinfo.mat')
    label_info = TID2013info["subjective_scores"]
    images_info = TID2013info["im_names"]

    distortion_types = ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10',
    ...
    for individual_type in distortion_types:
        ...
        for model_id in range(10):
            # Load model
            args.model_file = './save_model/TID2013-32-4-' + str(model_id + 1) + '.pth'
            ...
            pred_scores = []
            gt_scores = []
            file_dir = '/media/shuyuej/Projects/Dataset/tid2013/distorted_images/'

            for img_id in os.listdir(file_dir):
                if img_id[4:6] == individual_type:
            ...
            print(str(args.model_file) + ': TID2013 Database: ', str(individual_type), ' - SRCC', srcc, ' - PLCC', plcc)
...
if __name__ == "__main__":
    ...
    # Choose Database
    parser.add_argument('--num_dis_type', default=24, type=int, help='Number of distortion types (default: TID2013: 24)')
