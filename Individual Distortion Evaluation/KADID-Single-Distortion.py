...
def run(args):
    ...
    # TID2013
    KADIDinfo = mat73.loadmat('benchmark/KADID-10K.mat')
    label_info = KADIDinfo["subjective_scores"]
    images_info = KADIDinfo["im_names"]
    ...
    for individual_type in distortion_types:
        ...
        for model_id in range(10):
            # Load model
            args.model_file = './save_model/KADID-32-4-' + str(model_id + 1) + '.pth'
            ...
            pred_scores = []
            gt_scores = []
            file_dir = '/media/shuyuej/Projects/Dataset/kadid10k/images/'
            ...
            print(str(args.model_file) + ': KADID Database: ', str(individual_type), ' - SRCC', srcc, ' - PLCC', plcc)
...
if __name__ == "__main__":
    ...
    # Choose Database
    parser.add_argument('--num_dis_type', default=25, type=int, help='Number of distortion types (default: TID2013: 24)')
