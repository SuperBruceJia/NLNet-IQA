...
class Attention(nn.Module):
    ...
    def forward(self, h, adj):
        ...
        h_prime = h_prime.permute(0, 2, 1, 3).reshape(h_prime.shape[0], h_prime.shape[2], h_prime.shape[1] * h_prime.shape[3])
    ...
    def __repr__(self):
        return self.__class__.__name__ + ' (' + str(self.in_features) + ' -> ' + str(self.out_features * self.nheads) + ')'
